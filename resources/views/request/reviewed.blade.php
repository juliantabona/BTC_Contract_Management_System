    ...
    <div class="row">
                ...
                <div class="row flex-grow">
                    <div class="col-12 col-md-12 col-lg-12 grid-margin stretch-card">
                        <div class="card card-hoverable">
                            <div class="card-body">
                                <i class="float-left icon-eye icon-md icons ml-3"></i>
                                                                <h5 class="card-title float-left mt-2 mb-0 ml-2">Currently Reviewed</h5>
        ...
        ">David Mooketsi</a></td>                                           
                                                        <td style="text-align: center;">
                                                                                                                                                                                            ...
                                                                                                                                                                                            <i class="icon-eye mr-3"></i><i class="icon-note mr-3"></i>
        ...
        ">Keletso Mooketsi</a></td><td style="text-align: center;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row mt-4">
                                                        ...
                                                        <strong>126</strong>  results found
                                                    </p>
                                                                                            <nav>
