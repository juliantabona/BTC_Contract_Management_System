    ...
    <div class="row">
                ...
                <div class="row flex-grow">
                    <div class="col-12 col-md-12 col-lg-12 grid-margin stretch-card">
                        <div class="card card-hoverable">
                            <div class="card-body">
                                <i class="float-left icon-layers icon-md icons ml-3"></i>
                                                                <h5 class="card-title float-left mt-2 mb-0 ml-2">Authorized</h5>
                                        ...
                                        <table class="table mt-3 border-top">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="d-sm-none d-md-table-cell">Priority</th><th style="width: 18%">Authorized By</th>
        ...
        <i class="icon-note"></i>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row mt-4">
                                                        ...
                                                        <strong>187</strong>  results found
                                                    </p>
                                                                                            <nav>
