...
<div class="row">
    ...
    <div class="row">
                ...
                <div class="row flex-grow">
                    <div class="col-12 col-md-12 col-lg-12 grid-margin stretch-card">
                        <div class="card card-hoverable">
                            <div class="card-body">
                                <i class="float-left icon-note icon-md icons ml-3"></i>
                                                                <h5 class="card-title float-left mt-2 mb-0 ml-2">Waiting Signoff</h5>
                                        ...
                                        <table class="table mt-3 border-top">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="d-sm-none d-md-table-cell">Priority</th><th style="width: 18%">Approved By</th>
        ...
        <td class="d-none d-md-table-cell"><a href="#" style="
            text-decoration: underline;
        ">David Mooketsi</a></td>                                           
                                                        <td style="text-align: center;">
                                                              
                                                                                                                                                                                            <i class="icon-check mr-3"></i><i class="icon-close mr-3"></i>
                                                        ...
                                                        <td class="d-none d-md-table-cell">Medium</td><td class="d-none d-md-table-cell"><a href="#" style="
            text-decoration: underline;
        ">Karabo Mogala</a></td>                                           
                                                        <td style="text-align: center;">
                                                        ...
                                                        <td class="d-none d-md-table-cell"><a href="#" style="
            text-decoration: underline;
        ">Kabo Mapei</a></td><td style="text-align: center;">
                                                        ...
                                                        <td class="d-none d-md-table-cell"><a href="#" style="
            text-decoration: underline;
        ">Kealeboga Kotsi</a></td><td style="text-align: center;">
                                                        ...
                                                        <td class="d-none d-md-table-cell"><a href="#" style="
            text-decoration: underline;
        ">Keletso Mooketsi</a></td><td style="text-align: center;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-column flex-sm-row mt-4">
                                                        ...
                                                        <strong>107</strong>  results found
                                                    </p>
                                                                                            <nav>
